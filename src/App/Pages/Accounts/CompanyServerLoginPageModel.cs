    ...
    public class CompanyServerLoginPageModel : BaseViewModel
    {
        ...
        public async Task LogInAsync()
        {
            ...
            try
            {
                ...
                {
                    var twakeLoginUrlWithRedirect = twakeLoginUrlWithWellKnown + "?redirect_uri=cozypass://oidc";

                    await Browser.OpenAsync(twakeLoginUrlWithRedirect, new BrowserLaunchOptions
                    {
